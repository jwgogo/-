...
class System extends AdminBasic
{
    ...
    public function websocket(){
        ...
        $data['cmd1'] = "kill -9 ". $data['pid'];
        $data['cmd2'] = "php ".Env::get('root_path')."/swoole/Ws.php";
     ...
     * Argument :
     * User: 伍先生
     * DateTime: 2020/5/6 14:10
     * Function:  serveStart
     */
    public function serveStart(){
        $cmd2 = "php ".Env::get('root_path')."/swoole/Ws.php 2>&1";
