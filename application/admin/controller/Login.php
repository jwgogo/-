...
class Login extends Controller
{
    ...
    public function index(){
        ...
        //echo  $cookie = cookie('admin')."<br>";
        //
        //echo  $session = session('admin')."<br>";
        ////IP
        //echo $ip = get_client_ip()."<br>";
        //
        //echo $account = json_encode(session('account'))."<br>";
        //
        //
        //$data = db('admin')->where('id',$session)->find();
        //echo json_encode($data)."<br>";
        //
        //if(json_encode($data) == $account){
        //    echo "666<br>";
        //}else{
        //    echo "777<br>";
        //}
        //
        //echo set_session();die;
        ...
        if($this->request->post()){
            ...
            if($data){
                ...
                if ($data['is_del'] == 2){
                    $token = $this->request->token('__token__', 'sha1');
                    $this->result($token,-1,'你已被拉黑,请联系管理员');
                }
